        ...
        { // Called from "Aiming_Control_CS".
            ...
            switch (currentCameraPoint.Rotation_Type)
            {
                ...
                case 1: // Third person view.
                    ...
                    targetDir.y = 0.0f;
                    targetAngles.y = Vector3.Angle(Vector3.forward, targetDir) * Mathf.Sign(targetDir.x) + 90.0f;
                ...
                case 2: // First person view.
                    ...
                    targetAngles.y = Vector2.Angle(Vector2.up, local2DPos) * Mathf.Sign(local2DPos.x) + 90.0f;
                    targetAngles.z = -Mathf.Atan(localPos.y / local2DPos.magnitude) * Mathf.Rad2Deg + (Main_Camera.fieldOfView * 0.2f);
                    break;
            }
        }
